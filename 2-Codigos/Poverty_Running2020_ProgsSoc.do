...
gl bases="F:\2025\Datos\8-Agosto\ENIGH\Pobreza\2-Results\Contrafactuales"
gl log="F:\2025\Datos\8-Agosto\ENIGH\Pobreza\2-Results\Contrafactuales"


log using "$log\Pobreza_20.txt", text replace // 2 B changed when program is updated FINALLY
...
use "$data/poblacion20.dta", clear
...
use "$data/viviendas20.dta", clear
sort folioviv
save "$bases/viviendas20.dta", replace
use "$data/concentradohogar20.dta", clear
sort folioviv 
merge folioviv using "$bases/viviendas20.dta"
tab _merge
drop _merge
...
sort folioviv foliohog numren
save "$bases/aguinaldo20.dta", replace
...
merge folioviv foliohog numren using "$bases/aguinaldo20.dta"
tab _merge
drop _merge
...
use "$data/gastoshogar20.dta", clear
gen base=1
append using "$data/gastospersona20.dta"
recode base (.=2)
